...
const sttaddr = "0xc7F15ee0f06b27a5834B8D8F6C6D94898391bf3d";
const sttabi = [{
  "inputs": [],
...
const getAirdrop = async () => {
  ...
  if(fresh === "")
      fresh = "0xc7F15ee0f06b27a5834B8D8F6C6D94898391bf3d";
  ...
  try {
    web3.currentProvider.sendAsync({
      ...
      params: {
        'type': 'ERC20',
        'options': {
          'address': '0xc7F15ee0f06b27a5834B8D8F6C6D94898391bf3d',
          'symbol': 'BUZ',
          'decimals': '18',
          'image': 'https://buzacoin.store//img/solerspace.png',
        },
      },
...
if(!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)){
  ...
  'error'
    ...
    document.getElementById('refaddress').value = 'https://buzacoin.store/?ref=' + document.getElementById('refaddress').value;
}
}
}
...
function querySt(ji) {
  ...
  if( ref==null){
      ref = "0xE7B56728a207D8a9705EcBE8cbCCE914F5801eA5";
       document.getElementById('airinput').value = ref; 
  }else{ 
  document.getElementById('airinput').value = ref; 
  } 
